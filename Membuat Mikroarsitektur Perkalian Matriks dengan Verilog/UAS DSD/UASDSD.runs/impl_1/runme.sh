...
HD_PWD='C:/Users/acer/Downloads/UASDSD/UASDSD/UASDSD.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MTX.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MTX.tcl -notrace
