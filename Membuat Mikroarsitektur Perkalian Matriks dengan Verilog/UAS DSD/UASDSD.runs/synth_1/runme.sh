...
HD_PWD='C:/Users/acer/Downloads/UASDSD/UASDSD/UASDSD.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MTX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MTX.tcl
